...
export class City extends React.Component<ICityProps> {
  ...
  render() {
    ...
    return (
      <div>
        <h2 id="city-heading">
          <Translate contentKey="newcomerApp.city.home.title">Cities</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="newcomerApp.city.home.createLabel">Create new City</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {cityList && cityList.length > 0 ? (
            ...
            <div className="alert alert-warning">
              <Translate contentKey="newcomerApp.city.home.notFound">No Cities found</Translate>
            </div>
          )}
        </div>
      </div>
